// based on the GET from this endpoint
// https://www.research-software.nl/api/software?limit=1&sort="brandName"&direction="desc"
const LegacyRsdSoftwareExample = {
  "primaryKey": {
...
type RsdSoftwareType = typeof LegacyRsdSoftwareExample

export default RsdSoftwareType